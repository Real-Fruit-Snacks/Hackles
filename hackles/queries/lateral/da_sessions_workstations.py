...
def get_da_sessions_workstations(bh: BloodHoundCE, domain: Optional[str] = None, severity: Severity = None) -> int:
    ...
    if results:
        ...
        print_warning(f"[!] {unique_admins} admin(s) have sessions on {unique_computers} workstation(s) - CREDENTIAL THEFT TARGETS!")
