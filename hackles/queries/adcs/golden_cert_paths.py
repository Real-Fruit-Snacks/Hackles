...
@register_query(
    name="Golden Certificate Paths",
    category="ADCS",
    default=True,
    severity=Severity.CRITICAL
)
def get_golden_cert_paths(bh: BloodHoundCE, domain: Optional[str] = None, severity: Severity = None) -> int:
    ...
    if results:
        ...
        print_table(
            ["CA Host", "Domain"],
            [[r["ca_host"], r["domain"]] for r in results]
        )
