...
def get_gmsa_readers(bh: BloodHoundCE, domain: Optional[str] = None, severity: Severity = None) -> int:
    ...
    if results:
        ...
        print_abuse_info("ReadGMSAPassword", [{"principal": r["principal"], "gmsa": r["gmsa_account"]} for r in results], domain)
